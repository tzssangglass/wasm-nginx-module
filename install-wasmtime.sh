...
VER=v0.30.0
wget https://github.com/bytecodealliance/wasmtime/releases/download/${VER}/wasmtime-${VER}-x86_64-macos-c-api.tar.xz
tar -xvf ./wasmtime-${VER}-x86_64-macos-c-api.tar.xz > /dev/null
mv wasmtime-${VER}-x86_64-macos-c-api wasmtime-c-api
